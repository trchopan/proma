...
test("chooseConsolidatedTarget converts near-duplicate create_new to update_existing", () => {
  const target = chooseConsolidatedTarget({
    ...
    rankedCandidates: [
      {
        slug: "media-portal-weekly-highlights-xlt-beta-rollout-sentry-migration-and-engineering-updates",
        topic:
          "Media Portal weekly highlights: XLT beta rollout, sentry migration and engineering updates",
        tags: ["media-portal", "xlt", "weekly-highlights"],
        summary: "Consolidated weekly highlights for media portal",
        ...
        timeboxes: [],
        anchors: ["media-portal"],
      },
    ],
    aiTarget: {
      action: "create_new",
      shortDescription:
        "media-portal-weekly-highlights-xlt-beta-rollout-sentry-migration-dependency-and-engineering-updates",
      topic:
        "Media Portal weekly highlights: XLT beta rollout, sentry migration dependency and engineering updates",
      tags: ["media-portal", "weekly-highlights"],
    },
  });
